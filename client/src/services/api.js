...
export const googleLogin = (payload) => api.post('/auth/google', typeof payload === 'string' ? { credential: payload } : payload);
export const verifyCode = (email, code, username) => api.post('/auth/verify-code', { email, code, username });
